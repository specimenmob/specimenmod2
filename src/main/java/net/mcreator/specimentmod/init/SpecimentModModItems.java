...
import net.mcreator.specimentmod.item.ShyroSkylandItem;
...
import net.mcreator.specimentmod.item.McQueenManorItem;
...
import net.mcreator.specimentmod.item.KailonKaleidoscopeItem;
...
public class SpecimentModModItems {
	...
	public static final DeferredHolder<Item, Item> SHYRO_SKYLAND = REGISTRY.register("shyro_skyland", ShyroSkylandItem::new);
	...
	public static final DeferredHolder<Item, Item> MC_QUEEN_MANOR = REGISTRY.register("mc_queen_manor", McQueenManorItem::new);
	public static final DeferredHolder<Item, Item> MINO_MYSTERIA = REGISTRY.register("mino_mysteria", MinoMysteriaItem::new);
