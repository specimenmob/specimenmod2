...
@EventBusSubscriber
public class PneusoftQuandLentiteEstBlesseeProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, DamageSource damagesource, Entity entity) {
		...
		if (damagesource.is(DamageTypes.PLAYER_ATTACK)) {
			if (entity.getType().is(TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation("speciment_mod:pneusoft")))) {
