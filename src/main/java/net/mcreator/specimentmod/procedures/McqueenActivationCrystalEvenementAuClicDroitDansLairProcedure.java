...
public class McqueenActivationCrystalEvenementAuClicDroitDansLairProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SpecimentModModItems.MCQUEEN_ACTIVATION_CRYSTAL.get()) {
			...
			if (entity instanceof Player _player)
				_player.getCooldowns().addCooldown(SpecimentModModItems.MCQUEEN_ACTIVATION_CRYSTAL.get(), 200);
		}
	}
}
