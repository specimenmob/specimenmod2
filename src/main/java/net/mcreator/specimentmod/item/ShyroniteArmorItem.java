...
public abstract class ShyroniteArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), () -> Ingredient.of(new ItemStack(SpecimentModModItems.SHYRONITE.get())), List.of(new ArmorMaterial.Layer(new ResourceLocation("speciment_mod:shyronite"))), 0f, 0f);
