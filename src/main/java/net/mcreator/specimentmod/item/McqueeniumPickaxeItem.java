...
public class McqueeniumPickaxeItem extends PickaxeItem {
	private static final Tier TOOL_TIER = new Tier() {
		...
		public Ingredient getRepairIngredient() {
			return Ingredient.of(new ItemStack(SpecimentModModItems.MCQUEENIUM.get()));
		}
	};

	public McqueeniumPickaxeItem() {
