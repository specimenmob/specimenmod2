...
public abstract class McqueeniumArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), () -> Ingredient.of(new ItemStack(SpecimentModModItems.MCQUEENIUM.get())), List.of(new ArmorMaterial.Layer(new ResourceLocation("speciment_mod:mcqueenium"))), 0f, 0f);
