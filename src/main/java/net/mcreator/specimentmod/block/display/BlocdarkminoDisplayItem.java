...
public class BlocdarkminoDisplayItem extends BlockItem implements GeoItem {
	...
	public BlocdarkminoDisplayItem(Block block, Properties settings) {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new BlocdarkminoDisplayItemRenderer();
