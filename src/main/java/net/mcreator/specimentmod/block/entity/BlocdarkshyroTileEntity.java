...
public class BlocdarkshyroTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final SidedInvWrapper handler = new SidedInvWrapper(this, null);

	public BlocdarkshyroTileEntity(BlockPos pos, BlockState state) {
		super(SpecimentModModBlockEntities.BLOCDARKSHYRO.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(BlocdarkshyroBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BlocdarkshyroTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BlocdarkshyroTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("blocdarkshyro");
	}
