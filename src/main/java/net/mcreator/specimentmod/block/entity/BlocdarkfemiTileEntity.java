...
public class BlocdarkfemiTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final SidedInvWrapper handler = new SidedInvWrapper(this, null);

	public BlocdarkfemiTileEntity(BlockPos pos, BlockState state) {
		super(SpecimentModModBlockEntities.BLOCDARKFEMI.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(BlocdarkfemiBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BlocdarkfemiTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BlocdarkfemiTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
