package net.mcreator.specimentmod;
...
import net.mcreator.specimentmod.init.SpecimentModModTabs;
import net.mcreator.specimentmod.init.SpecimentModModSounds;
...
@Mod("speciment_mod")
public class SpecimentModMod {
	public static final Logger LOGGER = LogManager.getLogger(SpecimentModMod.class);
	public static final String MODID = "speciment_mod";

	public SpecimentModMod(IEventBus modEventBus) {
		...
		SpecimentModModVariables.ATTACHMENT_TYPES.register(modEventBus);
