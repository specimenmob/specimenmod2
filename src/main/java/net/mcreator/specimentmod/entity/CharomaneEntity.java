...
import net.mcreator.specimentmod.procedures.CharomaneQuandLeJoueurFaitUnClicDroitSurLentiteProcedure;
import net.mcreator.specimentmod.init.SpecimentModModEntities;

public class CharomaneEntity extends Monster {
	public CharomaneEntity(EntityType<CharomaneEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		CharomaneQuandLeJoueurFaitUnClicDroitSurLentiteProcedure.execute(world, x, y, z, entity);
		return retval;
	}

	public static void init(SpawnPlacementRegisterEvent event) {
		event.register(SpecimentModModEntities.CHAROMANE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
